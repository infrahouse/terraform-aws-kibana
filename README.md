...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_kibana"></a> [kibana](#module\_kibana) | registry.infrahouse.com/infrahouse/ecs/aws | 8.4.0 |
| <a name="module_kibana-encryptionKey"></a> [kibana-encryptionKey](#module\_kibana-encryptionKey) | registry.infrahouse.com/infrahouse/secret/aws | 1.3.0 |
| <a name="module_kibana-password"></a> [kibana-password](#module\_kibana-password) | registry.infrahouse.com/infrahouse/secret/aws | 1.3.0 |
...
| <a name="input_kibana_version"></a> [kibana\_version](#input\_kibana\_version) | Version of the Kibana Docker image to run.<br/>Elastic supports Kibana and Elasticsearch only on the same version (during an<br/>upgrade Elasticsearch may lead by one minor), so this must match the version<br/>of the cluster in elasticsearch\_url. In InfraHouse deployments the cluster<br/>version comes from the Puppet hiera key<br/>profile::elastic::packages::elasticsearch_version. | `string` | `"8.15.0"` | no |
